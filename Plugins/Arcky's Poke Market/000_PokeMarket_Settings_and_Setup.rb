module APMSettings
  ...
  BadgesForItems = {
    1 => [:GREATBALL, :SUPERPOTION, :ANTIDOTE, :PARALYZEHEAL, :AWAKENING, :BURNHEAL, :ICEHEAL, :REPEL],
    3 => [:HYPERPOTION, :SUPERREPEL, :REVIVE],
    3 => [:COMMONCANDY, :AIRBALLOON],
    5 => [:ULTRABALL, :FULLHEAL, :MAXREPEL, :MUSCLEBAND, :WISEGLASSES, :FIRESTONE, :THUNDERSTONE, :WATERSTONE, :LEAFSTONE, :MOONSTONE, :SUNSTONE, :DUSKSTONE, :DAWNSTONE, :SHINYSTONE, :ICESTONE],
    7 => [:MAXPOTION, :EVIOLITE, :ZOOMLENS,],
    8 => [:FULLRESTORE]
  }
  ...
  ItemPurchaseCounter = {
    101 => [:FLUTTERBALL, :GREATBALL, :ULTRABALL],
...
def pbBattleMart
  pbPokemonMart(["2daily",
    :MIRRORHERB, :MENTALHERB, :LEFTOVERS, :FIRESTONE, :THUNDERSTONE, :WATERSTONE, 
    :LEAFSTONE, :MOONSTONE, :SUNSTONE, :DUSKSTONE,
    :DAWNSTONE, :SHINYSTONE, :ICESTONE, :AIRBALLOON, :SHELLBELL, :WIDELENS,
    :ZOOMLENS, :EVIOLITE, :MUSCLEBAND, :WISEGLASSES
