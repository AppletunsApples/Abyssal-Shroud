module APMSettings
  ...
  BadgesForItems = {
    1 => [:GREATBALL, :SUPERPOTION, :ANTIDOTE, :PARALYZEHEAL, :AWAKENING, :BURNHEAL, :ICEHEAL],
    2 => [:HYPERPOTION, :REVIVE],
    3 => [:COMMONCANDY, :AIRBALLOON],
    5 => [:ULTRABALL, :FULLHEAL, :MUSCLEBAND, :WISEGLASSES, :FIRESTONE, :THUNDERSTONE, :WATERSTONE, :LEAFSTONE, :MOONSTONE, :SUNSTONE, :DUSKSTONE, :DAWNSTONE, :SHINYSTONE, :ICESTONE],
    7 => [:MAXPOTION, :LEFTOVERS, :EVIOLITE, :ZOOMLENS],
    8 => [:FULLRESTORE]
  }
